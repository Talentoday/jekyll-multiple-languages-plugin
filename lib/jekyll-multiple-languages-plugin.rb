    ...
    class LocalizeInclude < IncludeTag
      ...
      def render(context)
        ...
        Dir.chdir(includes_dir) do
          ...
          ######## Commenting this line for now because we do not have the translated files.
          ######## Should consider removing it since we now redirect anyway when supported_locales isn't present.
          # else
